...
// server
MACRO_CONFIG_STR(SvMusicBackendUrl, sv_music_backend_url, 256, "http://127.0.0.1:5000", CFGFLAG_SERVER, "Base URL of the local BauPlayerMusic backend")
MACRO_CONFIG_INT(SvMusicGlobalCooldown, sv_music_global_cooldown, 10, 0, 3600, CFGFLAG_SERVER, "Global /song cooldown after a queue song change in seconds")
MACRO_CONFIG_INT(SvMusicPlayerCooldown, sv_music_player_cooldown, 100, 0, 3600, CFGFLAG_SERVER, "Per-player /song cooldown in seconds")
MACRO_CONFIG_INT(SvMusicSearchResults, sv_music_search_results, 10, 1, 50, CFGFLAG_SERVER, "Maximum number of song search results shown to a player")
MACRO_CONFIG_INT(SvMusicVoteSearchResults, sv_music_vote_search_results, 20, 1, 50, CFGFLAG_SERVER, "Maximum number of song search results shown in the vote menu")
MACRO_CONFIG_INT(SvMusicPlaylistVisible, sv_music_playlist_visible, 10, 1, 50, CFGFLAG_SERVER, "Maximum number of queued songs shown by /mls")
MACRO_CONFIG_INT(SvMusicVoteProgressRefresh, sv_music_vote_progress_refresh, 1, 0, 60, CFGFLAG_SERVER, "Vote menu playback progress refresh interval in seconds (0 = disable timed refresh)")
MACRO_CONFIG_INT(SvMusicNextPreloadPercent, sv_music_next_preload_percent, 20, 0, 100, CFGFLAG_SERVER, "Playback percentage at which the next song starts preloading")
MACRO_CONFIG_INT(SvMusicPreloadRetryDelay, sv_music_preload_retry_delay, 30, 0, 3600, CFGFLAG_SERVER, "Delay before retrying a failed music preload in seconds")
MACRO_CONFIG_INT(SvMusicMaxPreloadFailures, sv_music_max_preload_failures, 3, 0, 100, CFGFLAG_SERVER, "Maximum automatic preload failures per song before retrying stops (0 = unlimited)")
MACRO_CONFIG_INT(SvMusicPreloadLogInterval, sv_music_preload_log_interval, 5, 0, 3600, CFGFLAG_SERVER, "Minimum interval for repeated preload skip log lines in seconds")
MACRO_CONFIG_INT(SvMusicQueueLogPreview, sv_music_queue_log_preview, 3, 1, 20, CFGFLAG_SERVER, "Number of queued songs printed by queue_status")
MACRO_CONFIG_INT(SvMusicMaxSongDuration, sv_music_max_song_duration, 3600, 1, 86400, CFGFLAG_SERVER, "Maximum accepted song duration in seconds")
MACRO_CONFIG_INT(SvMusicQQRelay, sv_music_qq_relay, 0, 0, 1, CFGFLAG_SERVER, "Enable QQ group message relay through the music backend")
MACRO_CONFIG_STR(SvMusicQQToken, sv_music_qq_token, 128, "", CFGFLAG_SERVER, "Shared token for QQ relay backend requests")
MACRO_CONFIG_INT(SvMusicQQGlobalCooldown, sv_music_qq_global_cooldown, 5, 0, 3600, CFGFLAG_SERVER, "Global cooldown for /qqmsg in seconds")
MACRO_CONFIG_INT(SvMusicQQPlayerCooldown, sv_music_qq_player_cooldown, 30, 0, 3600, CFGFLAG_SERVER, "Per-player cooldown for /qqmsg in seconds")
MACRO_CONFIG_INT(SvMusicQQMessageLength, sv_music_qq_message_length, 160, 1, 500, CFGFLAG_SERVER, "Maximum /qqmsg length in UTF-8 characters")
MACRO_CONFIG_INT(SvMusicQQPollInterval, sv_music_qq_poll_interval, 1, 1, 60, CFGFLAG_SERVER, "QQ relay poll interval in seconds")
MACRO_CONFIG_INT(SvMusicStateUpdateInterval, sv_music_state_update_interval, 2, 1, 60, CFGFLAG_SERVER, "Backend server status update interval in seconds")
MACRO_CONFIG_INT(SvTurtleSoupDummy, sv_turtle_soup_dummy, 1, 0, 1, CFGFLAG_SERVER, "Enable the Tee detective turtle soup dummy")
MACRO_CONFIG_STR(SvTurtleSoupDummyName, sv_turtle_soup_dummy_name, MAX_NAME_LENGTH, "Tee探长", CFGFLAG_SERVER, "Name of the turtle soup dummy")
MACRO_CONFIG_STR(SvTurtleSoupDummySkin, sv_turtle_soup_dummy_skin, MAX_SKIN_LENGTH, "for_abuelo", CFGFLAG_SERVER, "Skin of the turtle soup dummy")
...
MACRO_CONFIG_STR(SvMap, sv_map, 128, "a", CFGFLAG_SERVER, "Map to use on the server")
