...
class CServer : public IServer
{
	...
	void UpdateTurtleSoupDummy(bool ForceDisconnect);
...
public:
	...
	public:
		...
		{
			return m_State != STATE_EMPTY && !m_DebugDummy && !m_TurtleSoupDummy;
		}
	...
	bool IsTurtleSoupDummy(int ClientId) const override;
