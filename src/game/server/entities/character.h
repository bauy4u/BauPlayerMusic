...
public:
	...
	// Input paired with the current physics position. UI entities should use
	// this rather than direct input, which can belong to the next prediction frame.
	vec2 AimTarget() const { return vec2(m_Input.m_TargetX, m_Input.m_TargetY); }
